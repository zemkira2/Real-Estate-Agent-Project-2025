  ...
  return (
    <div className="min-h-screen bg-stone-50">
      ...
      <header className="bg-primary-900 border-b border-white/8 px-6">
        <div className="max-w-6xl mx-auto h-14 flex items-center gap-4">
          <Link
            href="/dashboard"
        ...
        <div className="grid lg:grid-cols-3 gap-7">
          ...
          <div>
            <div className="bg-white rounded-2xl border border-stone-200/70 shadow-card p-6 sticky top-6">
              ...
              <Link
                href="/dashboard"
                className="mt-5 flex items-center justify-center gap-2 w-full py-2.5 text-xs font-semibold text-stone-500 hover:text-primary-900 border border-stone-200 hover:border-stone-300 rounded-xl transition-all"
              >
                <svg
                  className="w-3.5 h-3.5"
                  fill="none"
